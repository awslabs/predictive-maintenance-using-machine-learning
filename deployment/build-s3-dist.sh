...
echo "cp -f predictive-maintenance-using-machine-learning.template $deployment_dir/dist"
cp -f predictive-maintenance-using-machine-learning.template $deployment_dir/dist
echo "Updating code source bucket in template with $1"
replace="s/%%BUCKET_NAME%%/$1/g"
echo "sed -i '' -e $replace $deployment_dir/dist/predictive-maintenance-using-machine-learning.template"
sed -i '' -e $replace $deployment_dir/dist/predictive-maintenance-using-machine-learning.template
...
cd $deployment_dir/../source/predictive_maintenance/
zip -q -r9 $deployment_dir/dist/predictive_maintenance.zip *
